...
name: demo
description: >
  Set up a Cogent Bridge demo with two sample projects
---
...
3. After the wizard completes, guide the user to:
   ...
   - Launch Codex in each project directory
   - Register each session on the bridge using the register skill
